...
const NavBar = () => {
  return (
    <header className="w-full fixed top-0 z-10 flex gap-4 p-4 bg-gradient-to-b from-black to-blue-800 shadow">
    <nav className="w-full container mx-auto flex flex-wrap items-center justify-between">
        <ul className="flex items-center justify-between font-bold text-sm text-white uppercase no-underline">
          ...
          <li>
            <Link className="text-slate-500 hover:text-sky-500 transition-colors flex items-center gap-2" href={"/profile"}>
              Perfil
            </Link>
          </li>
        </ul>
